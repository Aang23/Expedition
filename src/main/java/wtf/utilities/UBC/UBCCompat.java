...
public class UBCCompat {
	...
	private static final String[] IgneousStoneList = new String[]{"red_granite", "black_granite", "rhyolite", "andesite", "gabbro", "basalt", "komatiite", "dacite"};
	private static final String[] MetamorphicStoneList = new String[]{"gneiss", "eclogite", "marble", "quartzite", "blueschist", "greenschist", "soapstone", "migmatite"};
	private static final String[] SedimentaryStoneList = new String[]{"limestone", "chalk", "shale", "siltstone", "lignite", "dolomite", "greywacke", "chert"};
