...
public class BlockstateWriter {
	...
	private static String dir = "resourcepacks"+File.separatorChar+"WTFExpedition"+File.separatorChar+"assets"+File.separatorChar+"wtfcore"+File.separatorChar+"blockstates";
