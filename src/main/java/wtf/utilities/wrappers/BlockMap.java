...
public class BlockMap {
	...
	public boolean posQueued(BlockPos pos){
		return map.get(new ChunkStorCoords(pos)) != null && map.get(new ChunkStorCoords(pos)).get(new StoragePos(pos)) != null;
	}
	...
	public boolean add(BlockPos pos, QueuedGenerator qg){
		if (qg != null){
			...
			HashMap<StoragePos, Queue<QueuedGenerator>> exstor = map.computeIfAbsent(storcoords, k -> new HashMap<>());
	...
	private class ChunkStorCoords{
		...
		public boolean equals(Object obj) {
			...
			return getOuterType().equals(other.getOuterType()) && chunkX == other.chunkX && chunkZ == other.chunkZ && storY == other.storY;
		}
	...
	private class StoragePos{
		...
		public boolean equals(Object obj) {
			...
			return getOuterType().equals(other.getOuterType()) && x == other.x && y == other.y && z == other.z;
		}
