...
public class Vec {
	...
	public boolean equals(Object obj) {
		...
		if (ori == null) {
			...
			return false;
		return Double.doubleToLongBits(vecX) == Double.doubleToLongBits(other.vecX) && Double.doubleToLongBits(vecY) == Double.doubleToLongBits(other.vecY) && Double.doubleToLongBits(vecZ) == Double.doubleToLongBits(other.vecZ);
	}
