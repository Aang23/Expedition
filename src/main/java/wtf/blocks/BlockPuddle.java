...
public class BlockPuddle extends Block{
	...
	private static SoundType puddle = new SoundType(1.0F, 1.0F, SoundEvents.ENTITY_GENERIC_SPLASH, SoundEvents.BLOCK_SLIME_STEP, SoundEvents.ENTITY_GENERIC_SPLASH, SoundEvents.ENTITY_PLAYER_SPLASH, SoundEvents.ENTITY_GENERIC_SPLASH);
