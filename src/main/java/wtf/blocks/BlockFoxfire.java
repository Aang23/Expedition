...
public class BlockFoxfire extends AbstractActiveablePlant{
	...
	private static final AxisAlignedBB hangingBB = new AxisAlignedBB(0.2F, 0.0F, 0.2F, 0.8F, 0.8F, 0.8F);
	private static final AxisAlignedBB sittingBB = new AxisAlignedBB(0.2F, 0.0F, 0.2F, 0.8F, 0.8F, 0.8F);
