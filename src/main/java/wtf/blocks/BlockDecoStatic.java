...
public class BlockDecoStatic extends AbstractBlockDerivative{
	...
	public BlockDecoStatic(IBlockState state) {
		...
		if (BlockSets.fallingBlocks.containsKey(this.parentBackground.getBlock())){
			BlockSets.fallingBlocks.put(this, BlockSets.fallingBlocks.get(this.parentBackground.getBlock()));
		}
