...
public class TreeTypeGetter {
	...
	private static HashMap<WorldGenerator, AbstractTreeType> treeTypes = new HashMap<>();

	private final static IBlockState woodOak = Blocks.LOG.getDefaultState();
	...
	private final static IBlockState woodBirch = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH);
	private final static IBlockState woodJungle = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.JUNGLE);
	...
	private final static IBlockState leavesOak = Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
	...
	private final static IBlockState leavesBirch = Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
