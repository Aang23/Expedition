...
public class TreeInstance {
	...
	public TreeInstance(World world, Random random, ChunkScan chunkscan, BlockPos pos, AbstractTreeType tree){
		...
		this.snow = BiomeDictionary.getTypes(world.getBiome(pos)).contains(Type.SNOWY);
	...
	private Block[] groundArray = {Blocks.DIRT, Blocks.GRASS, Blocks.GRAVEL, Block.getBlockFromName("dirt0decoStatic")};
