...
public class DungeonTypeRegister {
	...
	private static AbstractDungeonType Mummy = new DungeonTypeMummy("Mummy");
	private static AbstractDungeonType Golem = new DungeonTypeDerangedGolem("DerangedGolem");
	private static AbstractDungeonType Bat = new DungeonTypeBatCave("BatCave", 10, 0);
	
	private static AbstractDungeonType CaveIn = new DungeonTypeCaveIn("Cavein");
	private static AbstractDungeonType Grotto = new DungeonSpeleothemGrotto("SpeleothemGrotto", 50, 50);
	private static AbstractDungeonType Mine = new DungeonMine("Mine");
	private static AbstractDungeonType BogLantern = new DungeonBogLantern("BogLangern");
	private static AbstractDungeonType ZombieFarm = new DungeonZombieFarmer("ZombieFarm");
