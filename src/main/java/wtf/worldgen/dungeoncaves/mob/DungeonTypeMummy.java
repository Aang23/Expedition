...
public class DungeonTypeMummy extends AbstractDungeonType{
	...
	private IBlockState chiseled = Blocks.SANDSTONE.getDefaultState().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.CHISELED);
	
	@Override
	public void generateCenter(GeneratorMethods gen, Random rand, CavePosition pos, float depth) {
		
		gen.spawnVanillaSpawner(pos.getFloorPos().up(), EntityList.getKey(Mummy.class), 5);
