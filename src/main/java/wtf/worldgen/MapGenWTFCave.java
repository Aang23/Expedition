...
public class MapGenWTFCave extends MapGenCaves{
    ...
    private static final IBlockState BLK_SANDSTONE = WTFBlocks.natSandStone.getDefaultState();
    private static final IBlockState BLK_RED_SANDSTONE = WTFBlocks.natRedSandStone.getDefaultState();
	
	private int sandstoneID = Blocks.SANDSTONE.getDefaultState().hashCode();
	private int redsandstonestoneID = Blocks.RED_SANDSTONE.getDefaultState().hashCode();
