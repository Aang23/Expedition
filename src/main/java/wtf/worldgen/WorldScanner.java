...
public class WorldScanner {
	...
	private HashSet<BlockPos> airBlocks = new HashSet<>();
	...
	public ChunkScan getChunkScan(World world, ChunkCoords coords, GeneratorMethods gen)
	{
		...
		return new ChunkScan(world, coords, gen, surfacepositions, surfaceaverage, unsortedcavepos, water);
	}
	...
	public boolean isAirAndCheck(Chunk chunk, GeneratorMethods gen, IBlockState state, int x, int y, int z) {
		...
		return replacer != null && replacer.isNonSolidAndReplacement(chunk, new BlockPos(x, y, z), gen, state);
	}
