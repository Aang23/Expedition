...
public class CoreWorldGenListener {
	...
	private static HashMap<Integer, GenScanMap> masterMap;
	...
	public void populate(PopulateChunkEvent.Post event){
		...
		GenScanMap worldMap = masterMap.computeIfAbsent(event.getWorld().provider.getDimension(), k -> new GenScanMap(event.getWorld()));
