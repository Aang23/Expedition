...
public class CaveTypeLush extends AbstractCaveType{
	...
	private final IBlockState leaves = Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.JUNGLE).withProperty(BlockLeaves.DECAYABLE, Boolean.FALSE);
	private final IBlockState roots = WTFBlocks.roots.getDefaultState().withProperty(BlockRoots.TYPE, BlockRoots.RootType.jungle);
	...
	private final IBlockState sapling = Blocks.SAPLING.getDefaultState().withProperty(BlockSapling.TYPE, BlockPlanks.EnumType.JUNGLE);
